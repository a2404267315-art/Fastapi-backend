...
class CyreneLLMModel: 
    def __init__(self,client=None,system_prompt=None,history_chat=None,model=None): #初始化客户端
        self.client=client
        self.system_prompt=system_prompt
        self.history_chat=history_chat if history_chat is not None else []
        self.model=model

    def chatting(self,contents:str,model="deepseek-chat",temperature=1.0,max_tokens=8192): 
